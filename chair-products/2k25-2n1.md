...
{% embed url="https://youtu.be/CUX9ZYGoBmI" %}

{% embed url="https://vimeo.com/1011678733" %}
...
Launch the game in windowed Once in the main menu of 2k, launch the tool. Don't click Activate all park functions Click unlock animations Go to attributes tinker the attributes that's only suitable for your build Click Save then Load
...
{% hint style="danger" %}
Some badges are mixed up \[List below]
{% endhint %}

Dimer = post fade fenom&#x20;

Handles = deadeye&#x20;

Unpluckable = limitless&#x20;

Post Lock = slippery off ball&#x20;

Challenger = bail out&#x20;

Post Fade = break starter&#x20;

Deadeye = Dimer&#x20;

Limitless = Handles for Days&#x20;

Slippery = Unpluckable&#x20;

Bail Out = Post&#x20;

Lockdown Break Starter = Challenger

**Badges**&#x20;

Click the checkbox that says "Lock custom attributes" Go to badges then tinker the badges that's suitable for your build Click Save then Load config Click Lock Custom Attributes Go to the city Then Click Read.
